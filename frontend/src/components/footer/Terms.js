    ...
    <Container>
      <div>
        ...
        <p className="text-muted">
          ...
          this Agreement, and (iii) any terms disclosed and agreed to by you if
          you purchase additional features, products or services we offer on the
          Service (collectively, this "Agreement"). If you do not accept and
          agree to be bound by all of the terms of this Agreement, please do not
          ...
          posted on the Service under Settings and also on gotinder.com, and you
          ...
          changes to your rights or obligations, we will notify you at least 30
          days in advance of the changes (unless we’re unable to do so under
          applicable law) by reasonable means, which could include notification
        ...
        <ul className="text-muted">
          ...
          <li>
            ...
            laws of Finalnd or any other applicable jurisdiction (for example,
            you
