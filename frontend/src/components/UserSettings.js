    ...
    <Container className="settings-container">
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Text className="text-muted">
            Change current username. Username should contain letters and numbers
            only with minimum length of 3
          </Form.Text>
        </Form.Group>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Text>Change your first or/and last name.</Form.Text>
        </Form.Group>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Text className="text-muted">
            Change your password. Password should contain at least 1 uppercase,
            1 lowercase letter, 1 number and 1 special character. Minimum length
            8.
          </Form.Text>
        </Form.Group>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Text>
            Change your biography. Max length 300 characters
          </Form.Text>
        </Form.Group>
